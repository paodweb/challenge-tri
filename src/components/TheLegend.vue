<template>
  ...
  <p>
    ...
    <span class="text-yellow-800">&nbsp;nombre de fois 1<sup>er.ère</sup> au classement (général ou catégorie)</span>&nbsp;
    <ContestedTriathlonsBadge></ContestedTriathlonsBadge>
    <span class="text-blue-700">&nbsp;nombre de triathlon(s) disputé(s)</span>&nbsp;
  </p>
  <br>
</template>
