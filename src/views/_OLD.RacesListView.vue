            ...
            <li
                ...
                <div class="flex min-w-0 gap-x-4">
                    <div class="min-w-0 flex-auto">
                        ...
                        <div class="mt-1 flex text-xs leading-5 text-gray-500 d-inline">
                ...
                <div class="flex shrink-0 items-center gap-x-8">
                    ...
                    <div class="hidden sm:flex sm:flex-col sm:items-end">
                        <p class="text-sm leading-6 text-gray-900">
                          <span class="inline-flex items-center rounded-full bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">1ère 🏃‍♀️ 02:18:18</span>
                          &nbsp;
                          <span class="inline-flex items-center rounded-full bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">1er 🏃‍♂️ 02:04:17</span>
                        </p>
