<template>
  <form @submit.prevent="onSubmit" role="form">
    <TheHeading title="Créer une course" v-bind="btn_attrs"> </TheHeading>
        ...
        <div class="border-b border-gray-900/10 pb-12">
          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="sm:col-span-6">
              <label for="form.title" class="block text-sm font-medium leading-6 text-gray-900 required"
            ...
            <div class="sm:col-span-6">
              <label for="form.date" class="block text-sm font-medium leading-6 text-gray-900 required"
            ...
            <div class="sm:col-span-6">
              <label for="form.numberClassifiedMenRunners" class="block text-sm font-medium leading-6 text-gray-900 required">Nombre de coureurs classés</label>
              <div class="mt-2">
            ...
            <div class="sm:col-span-6">
              <label for="form.numberClassifiedWomenRunners" class="block text-sm font-medium leading-6 text-gray-900 required">Nombre de coureuses classées</label>
              <div class="mt-2">
                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-pink-600 sm:max-w-md">
                  <input
            ...
            <div class="sm:col-span-6">
              <label for="form.timeFirstMan" class="block text-sm font-medium leading-6 text-gray-900 required">Temps 1er homme</label>
              <div class="mt-2">
                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-pink-600 sm:max-w-md">
                  <input
            ...
            <div class="sm:col-span-6">
              <label for="form.timeFirstWoman" class="block text-sm font-medium leading-6 text-gray-900 required">Temps 1ère femme</label>
              <div class="mt-2">
                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-pink-600 sm:max-w-md">
                  <input
...
function isValid() {
  ...
  // check times
  const check_times = isTimeValid(toRaw(form.value).timeFirstMan) && isTimeValid(toRaw(form.value).timeFirstWoman)
