...
<!--
    <h1 class="text-2xl font-bold py-5 px-3 tracking-tight text-gray-500 sm:text-2xl shadow d-inline">
      ...
      <span>trail aux pieds des Monts</span>
    </h1>
-->
...
-->
    ...
    <div style="max-height: 712px; overflow-y: scroll">
      <ul role="list" class="divide-y divide-gray-100">
        ...
        >
          <div class="flex min-w-0 gap-x-4">
            <img class="h-12 w-12 flex-none rounded-full bg-gray-50" :src="race.imageUrl" alt="" />
            <div class="min-w-0 flex-auto">
              ...
              <p class="mt-1 flex text-xs leading-5 text-gray-500">
                <a :href="`mailto:${race.email}`" class="relative truncate hover:underline">{{
                  race.email
                }}</a>
              </p>
            </div>
